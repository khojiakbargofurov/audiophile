    ...
    <div className="bg-[#141414] ">
      <div className="hero align-element">
        <div className="hero-content flex-col lg:flex-row-reverse">
          <picture>
            <source className="absolute" media="(maxwidth:950px)" srcSet={HeroImageTablet} />
          ...
          <div className="text-white lg:relative absolute max-w-[398px] text-center lg:text-left ">
            ...
            <Link to="/headphones"><button className="border-0 btn bg-[#D87D4A]">See Product</button></Link>
          </div>
        </div>
      </div>
    </div> 
